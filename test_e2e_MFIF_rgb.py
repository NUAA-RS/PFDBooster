...
if __name__ == "__main__":
    # 读取图像
    ir = cv2.imread('./dataset/MFI-WHU/ir/1.jpg', cv2.IMREAD_GRAYSCALE)
    vi = cv2.imread('./dataset/MFI-WHU/vis/1.jpg', cv2.IMREAD_GRAYSCALE)
    fused = cv2.imread('./outputs_enhancedMUFusion_mfif_rgb/1.jpg', cv2.IMREAD_GRAYSCALE)
