...
parser.add_argument('--path_to_ir_vis', default='./train_data/LLVIP/', help='root path to clean infrared and visible images (root/infrared/train, root/visible/train)')

#default = './train_data/outputsLLVIPTrain/'
parser.add_argument('--path_to_init_fus', default='./train_data/outputsLLVIPTrain/', help='root path to fusion results of an arbitrary method (root_init_fus/"ir or vis name.xxx")')
...
def train():
    ...
    ReconFuseNet_model = ReconFuseNet(dual_domain=True)
...
if __name__ == "__main__":
    model = ReconFuseNet(dual_domain=True)
    main()
